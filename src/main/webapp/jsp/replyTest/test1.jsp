...
<div class="container">
	...
	$(function() {
		...
		$("#btn1").click(function() {
			...
			$.post({
				...
				data: JSON.stringify(data), //data를 JSON형식으로 변환한 코드
				// 객체 -> string = stringify , string-> 객체 = parse
	...
	<h5>댓글 수정 form</h5>
	<input id="input1" name="rno" value="17" readonly> <br>
	<input id="input2" name="bno" value="92" readonly> <br>
