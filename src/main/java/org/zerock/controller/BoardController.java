...
public class BoardController {
	...
	*/
	...
	@PostMapping("/modify")
//	@PreAuthorize("principal.username == #board.writer") // 책 720내용
	@PreAuthorize("authentication.name == #board.writer") // spring.io
	...
	@GetMapping("/register")
	@PreAuthorize("isAuthenticated()") // 책 673~674 권한 내용
